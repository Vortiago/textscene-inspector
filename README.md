...
Around 117 node types, each a self-registering vertical slice.
...
| Physics | Bodies plus collision-shape gizmos; casts, spring arms, ragdoll bones and vehicle bodies are lint-checked |
