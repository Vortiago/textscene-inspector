...
### [#6] Sprite2D.modulate (CanvasItem, inherited)  (HIGH / sprite2d-animated / wrong-mapping) - [x]
...
### [#12] Control.size_flags_stretch_ratio  (MEDIUM / control-layout / wrong-mapping) - [x]
...
### [#16] Sprite2D.region_enabled + hframes/vframes combined  (MEDIUM / sprite2d-animated / wrong-mapping) - [x]
...
### [#29] Control.size_flags_stretch_ratio  (LOW / containers / missing) - [x]
...
### [#30] GridContainer â€” child SIZE_EXPAND does not widen columns  (LOW / containers / wrong-mapping) - [x]
...
### [#31] ScrollContainer.horizontal_scroll_mode / vertical_scroll_mode  (LOW / containers / missing) - [x]
...
### [#32] GridContainer child size_flags_horizontal (EXPAND columns)  (LOW / control-layout / wrong-mapping) - [x]
...
### [#38] CanvasItem.self_modulate  (LOW / sprite2d-animated / missing) - [x]
