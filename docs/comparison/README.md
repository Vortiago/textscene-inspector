...
- [SkeletonIK3D](../../packages/textscene-core/src/nodes/3d/skeleton/skeletonik3d/comparison.md) — a transform-only group (the deprecated 4.x two-bone IK solver)
- [SpringBoneCollisionCapsule3D](../../packages/textscene-core/src/nodes/3d/skeleton/springbonecollisioncapsule3d/comparison.md) — a transform-only group (a capsule spring bones collide with)
- [SpringBoneCollisionPlane3D](../../packages/textscene-core/src/nodes/3d/skeleton/springbonecollisionplane3d/comparison.md) — a transform-only group (an infinite plane spring bones collide with)
- [SpringBoneCollisionSphere3D](../../packages/textscene-core/src/nodes/3d/skeleton/springbonecollisionsphere3d/comparison.md) — a transform-only group (a sphere spring bones collide with)
- [XRBodyModifier3D](../../packages/textscene-core/src/nodes/3d/skeleton/xrbodymodifier3d/comparison.md) — a transform-only group (drives a skeleton from XR body tracking)
- [XRHandModifier3D](../../packages/textscene-core/src/nodes/3d/skeleton/xrhandmodifier3d/comparison.md) — a transform-only group (drives hand bones from XR hand tracking)
...
- [NinePatchRect](../../packages/textscene-core/src/nodes/2d/ui/ninepatchrect/comparison.md) — nothing yet; a texture stretched with fixed patch margins
- [ReferenceRect](../../packages/textscene-core/src/nodes/2d/ui/referencerect/comparison.md) — nothing yet; a debug border around its rect
