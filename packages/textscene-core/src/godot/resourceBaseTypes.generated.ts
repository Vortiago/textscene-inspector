/**
 * Resource-type → base-type table, derived from Godot 4.6.3.stable.fedora.7d41c59c4's ClassDB.
...
export const RESOURCE_BASE_TYPES_GENERATED: Readonly<Record<string, string>> = Object.freeze({
  ...
  AudioStreamMP3: 'AudioStream',
  AudioStreamOggVorbis: 'AudioStream',
  ...
  GLTFAccessor: 'Resource',
  GLTFAnimation: 'Resource',
  GLTFBufferView: 'Resource',
  GLTFCamera: 'Resource',
  GLTFDocument: 'Resource',
  GLTFDocumentExtension: 'Resource',
  GLTFDocumentExtensionConvertImporterMesh: 'GLTFDocumentExtension',
  GLTFDocumentExtensionPhysics: 'GLTFDocumentExtension',
  GLTFDocumentExtensionTextureKTX: 'GLTFDocumentExtension',
  GLTFDocumentExtensionTextureWebP: 'GLTFDocumentExtension',
  GLTFLight: 'Resource',
  GLTFMesh: 'Resource',
  GLTFNode: 'Resource',
  GLTFPhysicsBody: 'Resource',
  GLTFPhysicsShape: 'Resource',
  GLTFSkeleton: 'Resource',
  GLTFSkin: 'Resource',
  GLTFSpecGloss: 'Resource',
  GLTFState: 'Resource',
  GLTFTexture: 'Resource',
  GLTFTextureSampler: 'Resource',
  Gradient: 'Resource',
  ...
  Noise: 'Resource',
  NoiseTexture2D: 'Texture2D',
  NoiseTexture3D: 'Texture3D',
  Occluder3D: 'Resource',
  OccluderPolygon2D: 'Resource',
  OggPacketSequence: 'Resource',
  OpenXRAction: 'Resource',
  OpenXRActionBindingModifier: 'OpenXRBindingModifier',
  OpenXRActionMap: 'Resource',
  OpenXRActionSet: 'Resource',
  OpenXRAnalogThresholdModifier: 'OpenXRActionBindingModifier',
  OpenXRBindingModifier: 'Resource',
  OpenXRDpadBindingModifier: 'OpenXRIPBindingModifier',
  OpenXRHapticBase: 'Resource',
  OpenXRHapticVibration: 'OpenXRHapticBase',
  OpenXRInteractionProfile: 'Resource',
  OpenXRIPBinding: 'Resource',
  OpenXRIPBindingModifier: 'OpenXRBindingModifier',
