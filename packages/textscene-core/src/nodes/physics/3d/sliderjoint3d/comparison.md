...
Strict parsing format-checks these `SliderJoint3D` properties, plus 4 inherited from Joint3D, 16 inherited from Node3D. Every validator failure is an **error**.
