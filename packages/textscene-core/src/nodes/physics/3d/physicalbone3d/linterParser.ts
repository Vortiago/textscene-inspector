 ...
 *   - `joint_constraints/...`: per-joint-type parameters, keyed on the runtime
 *     `joint_type` — never a static ADD_PROPERTY. See jointConstraints.ts.
 *
 ...
 * duplicates the rule; PhysicsBody3D's `axis_lock_*` arrive the same way.
 */
