...
Strict parsing format-checks these `PhysicalBone3D` properties, plus 6 inherited from CollisionObject3D, 16 inherited from Node3D. Every validator failure is an **error**.
