...
Strict parsing format-checks these `PhysicalBone3D` properties, plus 6 inherited from CollisionObject3D, 17 inherited from Node3D, 10 inherited from Node. Every validator failure is an **error**.
