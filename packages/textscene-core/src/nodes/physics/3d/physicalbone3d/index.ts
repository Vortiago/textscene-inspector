/**
 * PhysicalBone3D registration: the parser.
 *
...
const physicalBone3DRegistration: NodeTypeRegistration = {
  typeName: 'PhysicalBone3D',
  parser: parseNode3D,
};

nodeRegistry.register(physicalBone3DRegistration);

export { physicalBone3DRegistration };
