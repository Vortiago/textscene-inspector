/**
 * HingeJoint3D registration: the parser.
 *
...
const hingeJoint3DRegistration: NodeTypeRegistration = {
  typeName: 'HingeJoint3D',
  parser: parseNode3D,
};

nodeRegistry.register(hingeJoint3DRegistration);

export { hingeJoint3DRegistration };
