/**
 * CollisionPolygon3D strict validators — format and range checks.
 *
 ...
 * CollisionPolygon3D binds, or set DECLARES_NOTHING when it binds no ADD_PROPERTY at all.
...
/**
 * Keys CollisionPolygon3D does NOT declare, each paired with the ancestor that does.
 ...
 * an EMPTY set and passes while asserting nothing — "Godot gives CollisionPolygon3D no
...
describe('CollisionPolygon3D strict validators', () => {
  ...
  it('rejects a malformed value on every property it validates', () => {
    ...
    // CollisionPolygon3D declares nothing, which is what INHERITED below covers.
