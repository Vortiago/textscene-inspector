/**
 * RayCast3D strict validators, asserted through `validatorRegistry`, not by linting a `.tscn`,
 * so a failure points at the validator. Rule-level behaviour is the shared cast factory's,
 * tested in linter/physics/castLinterRule.test.ts.
 */
