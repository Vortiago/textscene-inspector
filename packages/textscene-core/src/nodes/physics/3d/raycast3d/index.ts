/**
 * RayCast3D registration: the parser.
 *
...
const rayCast3DRegistration: NodeTypeRegistration = {
  typeName: 'RayCast3D',
  parser: parseNode3D,
};

nodeRegistry.register(rayCast3DRegistration);

export { rayCast3DRegistration };
