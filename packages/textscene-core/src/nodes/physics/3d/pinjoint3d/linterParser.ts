/**
 * PinJoint3D strict validators: only the members doc/classes/PinJoint3D.xml lists without
 * `overrides=`. The NODE_BASE_TYPES base-walk delivers everything from Joint3D up, and a
