...
Strict parsing format-checks these `PinJoint3D` properties, plus 4 inherited from Joint3D, 16 inherited from Node3D, 10 inherited from Node. Every validator failure is an **error**.

| Property | Accepts |
| --- | --- |
| `params/bias` | float 0.01-0.99 |
| `params/damping` | float 0.01-8 |
| `params/impulse_clamp` | float 0-64 |
