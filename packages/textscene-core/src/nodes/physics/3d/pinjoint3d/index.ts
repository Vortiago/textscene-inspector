/**
 * PinJoint3D registration: the parser.
 *
...
const pinJoint3DRegistration: NodeTypeRegistration = {
  typeName: 'PinJoint3D',
  parser: parseNode3D,
};

nodeRegistry.register(pinJoint3DRegistration);

export { pinJoint3DRegistration };
