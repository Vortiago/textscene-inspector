...
const physicalBone2DRegistration: NodeTypeRegistration = {
  typeName: 'PhysicalBone2D',
  parser: parseNode2D,
};

nodeRegistry.register(physicalBone2DRegistration);

export { physicalBone2DRegistration };
