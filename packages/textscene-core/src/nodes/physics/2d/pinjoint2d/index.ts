/**
 * PinJoint2D registration: the parser.
 *
...
const pinJoint2DRegistration: NodeTypeRegistration = {
  typeName: 'PinJoint2D',
  parser: parseNode2D,
};

nodeRegistry.register(pinJoint2DRegistration);

export { pinJoint2DRegistration };
