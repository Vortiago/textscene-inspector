/**
 * GrooveJoint2D registration: the parser.
 *
...
const grooveJoint2DRegistration: NodeTypeRegistration = {
  typeName: 'GrooveJoint2D',
  parser: parseNode2D,
};

nodeRegistry.register(grooveJoint2DRegistration);

export { grooveJoint2DRegistration };
