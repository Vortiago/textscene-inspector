/**
 * GPUParticlesAttractorBox3D strict validators for linting: only its own members, the ones
 * doc/classes/GPUParticlesAttractorBox3D.xml lists without `overrides=`. The NODE_BASE_TYPES
