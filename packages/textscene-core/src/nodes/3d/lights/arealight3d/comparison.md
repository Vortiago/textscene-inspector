...
Strict parsing format-checks these `AreaLight3D` properties, plus 15 inherited from Light3D, 16 inherited from Node3D. Every validator failure is an **error**.
...
| `valid-arealight3d-properties` | `arealight3d-extreme-energy` | warning |
<!-- lint:end -->
