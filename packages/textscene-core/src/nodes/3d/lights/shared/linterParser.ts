/** Shared light property validators used by all Light3D subtypes. */

import { COLOR_REGEX } from '../../../../linter/validators/vectorValidators.js';
import type { ParseError } from '../../../../linter/types.js';

type Validator = (key: string, value: string, line: number) => ParseError | null;

export const sharedLightValidators: Record<string, Validator> = {
  /**
