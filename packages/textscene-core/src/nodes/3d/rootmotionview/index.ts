...
const rootMotionViewRegistration: NodeTypeRegistration = {
  typeName: 'RootMotionView',
  parser: parseNode3D,
};

nodeRegistry.register(rootMotionViewRegistration);

export { rootMotionViewRegistration };
