...
const navigationLink3DRegistration: NodeTypeRegistration = {
  typeName: 'NavigationLink3D',
  parser: parseNode3D,
};

nodeRegistry.register(navigationLink3DRegistration);

export { navigationLink3DRegistration };
