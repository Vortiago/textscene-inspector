...
Strict parsing format-checks these `NavigationLink3D` properties, plus 17 inherited from Node3D, 10 inherited from Node. Every validator failure is an **error**.
