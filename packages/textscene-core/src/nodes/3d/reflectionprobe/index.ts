/**
 * ReflectionProbe registration — parser.
 *
...
const reflectionProbeRegistration: NodeTypeRegistration = {
  typeName: 'ReflectionProbe',
  parser: parseNode3D,
};

nodeRegistry.register(reflectionProbeRegistration);

export { reflectionProbeRegistration };
