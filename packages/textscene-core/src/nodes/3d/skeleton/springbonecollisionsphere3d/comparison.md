...
Strict parsing format-checks these `SpringBoneCollisionSphere3D` properties, plus 4 inherited from SpringBoneCollision3D, 16 inherited from Node3D, 10 inherited from Node. Every validator failure is an **error**.
