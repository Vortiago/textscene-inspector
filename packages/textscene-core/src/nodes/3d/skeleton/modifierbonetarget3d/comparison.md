...
Strict parsing format-checks these `ModifierBoneTarget3D` properties, plus 2 inherited from SkeletonModifier3D, 16 inherited from Node3D, 10 inherited from Node. Every validator failure is an **error**.
