...
const openXRCompositionLayerCylinderRegistration: NodeTypeRegistration = {
  typeName: 'OpenXRCompositionLayerCylinder',
  parser: parseNode3D,
};

nodeRegistry.register(openXRCompositionLayerCylinderRegistration);

export { openXRCompositionLayerCylinderRegistration };
