/**
 * VisibleOnScreenEnabler3D strict validators, asserted through `validatorRegistry`, not by
...
/**
 * The keys VisibleOnScreenEnabler3D binds, read from the source. Set this or DECLARES_NOTHING,
...
/**
 * Keys VisibleOnScreenEnabler3D does not declare, each paired with the ancestor that does. The
