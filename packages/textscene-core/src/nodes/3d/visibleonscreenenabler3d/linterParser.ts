...
// visible_on_screen_notifier_3d.cpp:198-199. The class binds no `PropertyListHelper`, no
// `ADD_ARRAY_COUNT`, no `_set`/`_get`/property-list override in either spelling, and has no
// `.compat.inc`.
