...
describe('NavigationRegion3D strict validators', () => {
  ...
  describe('enter_cost — navigation_region_3d.cpp:302, plain FLOAT with NO PROPERTY_HINT_RANGE', () => {
    // set_enter_cost (:132) opens with ERR_FAIL_COND_MSG(p_enter_cost < 0.0):
  ...
  describe('travel_cost — navigation_region_3d.cpp:303, plain FLOAT with NO PROPERTY_HINT_RANGE', () => {
    // set_travel_cost (:147) opens with ERR_FAIL_COND_MSG(p_travel_cost < 0.0):
