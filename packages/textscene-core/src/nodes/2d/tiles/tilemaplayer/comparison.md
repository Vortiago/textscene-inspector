...
Strict parsing format-checks these `TileMapLayer` properties, plus 12 inherited from Node2D, 15 inherited from CanvasItem. Every validator failure is an **error**.
