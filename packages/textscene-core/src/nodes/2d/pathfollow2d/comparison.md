...
Strict parsing format-checks these `PathFollow2D` properties, plus 12 inherited from Node2D, 15 inherited from CanvasItem, 10 inherited from Node. Every validator failure is an **error**.
...
| `valid-pathfollow2d` | `pathfollow2d-no-parent` | error |
|  | `pathfollow2d-invalid-parent` | error |
