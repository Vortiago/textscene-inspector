/**
 * VisibleOnScreenEnabler2D strict validators — format and range checks.
 *
 ...
 * VisibleOnScreenEnabler2D binds, or set DECLARES_NOTHING when it binds no ADD_PROPERTY at all.
...
/**
 * Keys VisibleOnScreenEnabler2D does NOT declare, each paired with the ancestor that does.
 * Name at least one; VisibleOnScreenNotifier2D is where to start.
 *
 ...
 * an EMPTY set and passes while asserting nothing — "Godot gives VisibleOnScreenEnabler2D no
...
describe('VisibleOnScreenEnabler2D strict validators', () => {
  ...
  it('rejects a malformed value on every property it validates', () => {
    ...
    // VisibleOnScreenEnabler2D declares nothing, which is what INHERITED below covers.
