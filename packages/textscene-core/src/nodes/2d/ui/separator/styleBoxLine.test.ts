/**
 * `parseStyleBoxLine`/`defaultSeparatorStyleBoxLine` — `style_box_line.h`/
 * `.cpp` and `default_theme.cpp:734-740,1063-1069` (Godot 4.6.3).
 */
import { describe, expect, it } from 'vitest';
import type { TscnInternalResource } from '../../../../parser/types';
import { nativeTheme } from '../../../../r3f/controls/native/nativeTheme';
import { parseStyleBoxLine, defaultSeparatorStyleBoxLine } from './styleBoxLine';
