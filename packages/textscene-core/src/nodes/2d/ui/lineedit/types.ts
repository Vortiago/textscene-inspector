...
export interface LineEditProperties extends ControlProperties {
  ...
  /** `HorizontalAlignment`: 0 LEFT, 1 CENTER, 2 RIGHT, 3 FILL. Godot default 0. FILL shares LEFT's draw branch. */
  alignment?: number;
  ...
  secret?: boolean;
  /** The character `secret` echoes. Godot default "•". Only its first character is used. */
  secretCharacter?: string;
  /** Suppress the background stylebox entirely. Godot default false. */
  flat?: boolean;
  /** Truncates `text` to this many code points. 0, the Godot default, is unlimited. */
  maxLength?: number;
  ...
  /** Raw `right_icon` ref (for example `ExtResource("id")`), or `undefined` or `"null"` for none. */
  rightIcon?: string;
  ...
  /** Draws the caret even when unfocused or not editing. Godot default false. */
