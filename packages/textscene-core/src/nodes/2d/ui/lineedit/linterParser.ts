...
validatorRegistry.registerAll('LineEdit', {
  ...
  // line_edit.cpp:3510 — PROPERTY_HINT_RANGE "0.1,10,0.01" is the editor slider
  // only; set_caret_blink_interval (line_edit.cpp:2049-2052) enforces just
  // `ERR_FAIL_COND(p_interval <= 0)` (line_edit.cpp:2050), so any positive float
  // is engine-valid even past the slider's 10 ceiling.
  caret_blink_interval: v.positiveFloat('caret_blink_interval', undefined, {
    enforced: 'line_edit.cpp:2050',
  }),
