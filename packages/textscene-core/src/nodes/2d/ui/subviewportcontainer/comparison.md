...
Strict parsing format-checks these `SubViewportContainer` properties, plus 26 inherited from Control, 15 inherited from CanvasItem. Every validator failure is an **error**.
