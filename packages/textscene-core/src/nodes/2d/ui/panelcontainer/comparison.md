...
Strict parsing format-checks the inherited set (26 inherited from Control, 15 inherited from CanvasItem, 10 inherited from Node); `PanelContainer` declares none of its own. Every validator failure is an **error**.
