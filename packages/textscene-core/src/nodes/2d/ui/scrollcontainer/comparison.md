...
Strict parsing format-checks the inherited set (27 inherited from Control, 15 inherited from CanvasItem, 10 inherited from Node); `ScrollContainer` declares none of its own. Every validator failure is an **error**.
