/**
 * `<ScrollContainerNative>` render contract. Geometry expectations mirror
 ...
 * group (see `NativeComponent.tsx`'s own doc for why an un-flipped
...
describe('<ScrollContainerNative> — no scrollbar when content fits', () => {
...
describe('<ScrollContainerNative> — vertical scrollbar geometry (real-fixture numbers)', () => {
...
describe('<ScrollContainerNative> — tint', () => {
  ...
  it('composes self_modulate with the ambient ONCE, not squared (mirrors PanelContainerNative)', async () => {
...
describe('<ScrollContainerNative> — clip planes', () => {
