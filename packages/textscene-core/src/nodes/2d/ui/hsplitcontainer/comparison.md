...
Strict parsing format-checks these `HSplitContainer` properties, plus 10 inherited from SplitContainer, 26 inherited from Control, 15 inherited from CanvasItem. Every validator failure is an **error**.
