...
<!-- lint:begin Range -->
Strict parsing format-checks these `Range` properties, plus 28 inherited from Control, 16 inherited from CanvasItem, 10 inherited from Node. Every validator failure is an **error**.
