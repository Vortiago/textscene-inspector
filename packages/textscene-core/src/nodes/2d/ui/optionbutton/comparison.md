...
Strict parsing format-checks the inherited set (10 inherited from BaseButton, 29 inherited from Control); `OptionButton` declares none of its own. Every validator failure is an **error**.
