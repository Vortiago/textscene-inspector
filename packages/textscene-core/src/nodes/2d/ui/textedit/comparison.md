...
<!-- lint:begin TextEdit -->
Strict parsing format-checks these `TextEdit` properties, plus 26 inherited from Control, 15 inherited from CanvasItem, 10 inherited from Node. Every validator failure is an **error**.
