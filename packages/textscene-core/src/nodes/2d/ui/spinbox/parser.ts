/** SpinBox parser — Control + Range bases plus SpinBox's own properties (`spin_box.cpp:673-680`). */
...
export function parseSpinBox(
  ...
  return {
    ...
    // SpinBox sets `step = 1.0` in its constructor — measured from the engine
