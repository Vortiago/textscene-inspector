/**
 * `<TextureRectNative>` render contract. `nodes/2d/marker2d/Component.test.tsx`
...
describe('<TextureRectNative> (isolated painter contract)', () => {
...
describe('<TextureRectNative> registered through <ControlCanvasWalker> (end-to-end walker plumbing)', () => {
  it('draws its quad through the real registry entry, at the walker-solved rect', async () => {
    controlComponentRegistry.register({ typeName: 'TextureRect', Component: DomStub, Native: TextureRectNative });
