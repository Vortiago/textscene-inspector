/**
 * VSlider's native (WebGL canvas) minimum-size solve: the shared Slider port at
 * `vertical = true`. The algorithm lives in `../shared/sliderSolver.ts` for both sliders.
 */
