...
<!-- lint:begin VSlider -->
Strict parsing format-checks the inherited set (9 inherited from Range, 26 inherited from Control, 15 inherited from CanvasItem); `VSlider` declares none of its own. Every validator failure is an **error**.
