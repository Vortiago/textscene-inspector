...
VSlider is a vertical slider over a Range, measured from the bottom: `min_value` puts
the grabber at the bottom and the fill grows upward. The previewer draws the same four
parts as HSlider.
