...
<!-- lint:begin VSlider -->
Strict parsing format-checks the inherited set (9 inherited from Range, 29 inherited from Control); `VSlider` declares none of its own. Every validator failure is an **error**.
