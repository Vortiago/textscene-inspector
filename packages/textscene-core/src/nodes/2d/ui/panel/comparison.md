...
<!-- lint:begin Panel -->
Strict parsing format-checks the inherited set (28 inherited from Control, 16 inherited from CanvasItem, 10 inherited from Node); `Panel` declares none of its own. Every validator failure is an **error**.
