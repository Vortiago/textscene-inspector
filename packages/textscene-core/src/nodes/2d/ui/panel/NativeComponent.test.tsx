...
describe('<PanelNative> (isolated painter contract)', () => {
...
describe('<PanelNative> registered through <ControlCanvasWalker> (end-to-end walker plumbing)', () => {
  it('honours visible === false on the Panel node itself (the WALKER hides the group, not this painter)', async () => {
    controlComponentRegistry.register({ typeName: 'Panel', Component: DomStub, Native: PanelNative });
