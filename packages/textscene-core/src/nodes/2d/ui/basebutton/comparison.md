...
Strict parsing format-checks these `BaseButton` properties, plus 27 inherited from Control, 15 inherited from CanvasItem, 10 inherited from Node. Every validator failure is an **error**.
