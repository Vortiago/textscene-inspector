...
Strict parsing format-checks these `GraphElement` properties, plus 26 inherited from Control, 15 inherited from CanvasItem. Every validator failure is an **error**.
