...
| `max_size` | Vector2i(x, y), both >= 0 | error |
| `maximize_disabled` | true or false |  |
| `min_size` | Vector2i(x, y), both >= 0 | error |
...
| `size` | Vector2i(x, y), both >= 0 | error |
