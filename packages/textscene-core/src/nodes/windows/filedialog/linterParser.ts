...
// (file_dialog.cpp:2136-2138), which the storage guard (packed_scene.cpp:865) never saves, so no
// validator. `dialog_text` keeps AcceptDialog's validator: it is hidden but no removal
// (`linter/removalKeys.md`).
