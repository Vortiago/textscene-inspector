...
| Property | Accepts |
| --- | --- |
| `access` | enum 0-2 (RESOURCES/USERDATA/FILESYSTEM) |
| `deleting_enabled` | true or false |
| `display_mode` | enum 0-1 (THUMBNAILS/LIST) |
| `favorites_enabled` | true or false |
| `file_filter_toggle_enabled` | true or false |
| `file_mode` | enum 0-4 (OPEN_FILE/OPEN_FILES/OPEN_DIR/OPEN_ANY/SAVE_FILE) |
...
| `valid-filedialog-properties` (type-family match) | `filedialog-option-index-out-of-range` | warning |
<!-- lint:end -->
