 ...
 * known, with wrapping at three's clamp default. A default material asks for
 * Repeat, so a slot gets a clone that shares the source, and `.source` identity
 * proves the decoded image reached the slot below.
 */
