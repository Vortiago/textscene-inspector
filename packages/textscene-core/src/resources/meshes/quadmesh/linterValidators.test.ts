 ...
 * PlaneMesh's, `flip_faces` and `material` are PrimitiveMesh's. Its own copies
 * would be a shadow that drifts, so the cases below ride the resource base-walk
 * and are what proves it reaches a leaf two hops down.
 */
