/**
 * Curve3D parsing + polyline tessellation for Path3D / PathFollow3D.
 *
 * The 3D twin of curve2d.ts. Godot stores a Curve3D as
 ...
 *
 * Pure module (no THREE). Godot 3D space is right-handed Y-up, matching three.js,
 * so coordinates map directly (no conjugation, unlike the 2D twin).
 */
