...
export function parseEnvironment(
  ...
  return {
    ...
    background_color: parseColorOrUndefined(properties.background_color) ?? { r: 0, g: 0, b: 0, a: 1 },
    ...
    ambient_light_color: parseColorOrUndefined(properties.ambient_light_color) ?? { r: 0, g: 0, b: 0, a: 1 },
    ...
    fog_light_color: parseColorOrUndefined(properties.fog_light_color) ?? { r: 0.518, g: 0.553, b: 0.608, a: 1 },
    ...
    volumetric_fog_albedo: parseColorOrUndefined(properties.volumetric_fog_albedo) ?? { r: 1, g: 1, b: 1, a: 1 },
    volumetric_fog_emission: parseColorOrUndefined(properties.volumetric_fog_emission) ?? { r: 0, g: 0, b: 0, a: 1 },
