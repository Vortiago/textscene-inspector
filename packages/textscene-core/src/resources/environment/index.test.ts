...
// Importing the entry point registers the claim. The assertions read the registry by
// name, never `all()`, whose contents depend on which other slice indexes a test file
// pulls in.
