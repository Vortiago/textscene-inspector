/**
 * Regression tests for the LD-58 hallway wall transforms.
 *
 * These tests use the actual Transform3D values from
...
describe('LD-58 hallway wall transforms — regression suite', () => {
