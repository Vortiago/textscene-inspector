...
export const fixtures: Fixture[] = [
  ...
  {
    "name": "Dynamic Tilemap Layers (2D): world",
    "file": "demos/2d/dynamic_tilemap_layers/world.tscn",
    "category": "Godot Demos - 2D",
    "root": "demos/2d/dynamic_tilemap_layers"
  },
  {
    "name": "Finite State Machine (2D): Demo",
  ...
  {
    "name": "Glow (2D): beach_cave",
    "file": "demos/2d/glow/beach_cave.tscn",
    "category": "Godot Demos - 2D",
    "root": "demos/2d/glow"
  },
  {
    "name": "Hexagonal Map (2D): map",
  ...
  {
    "name": "Instancing (2D): scene_instancing",
  ...
  {
    "name": "Physics Platformer (2D): stage",
  ...
  {
    "name": "Platformer (2D): game_singleplayer",
  ...
  {
    "name": "Polygons Lines (2D): polygons_lines",
  ...
  {
    "name": "Role Playing Game (2D): game",
  ...
  {
    "name": "Sprite Shaders (2D): sprite_shaders",
  ...
  {
    "name": "Antialiasing (3D): anti_aliasing",
  ...
  {
    "name": "Global Illumination (3D): test",
  ...
  {
    "name": "Graphics Settings (3D): control",
  ...
  {
    "name": "Kinematic Character (3D): level",
  ...
  {
    "name": "Navigation (3D): navmesh",
    "file": "demos/3d/navigation/navmesh.tscn",
    "category": "Godot Demos - 3D",
    "root": "demos/3d/navigation"
  },
  {
    "name": "Navigation Mesh Chunks (3D): navmesh_chhunks_demo_3d",
  ...
  {
    "name": "Procedural Materials (3D): loading",
  ...
  {
    "name": "Ragdoll Physics (3D): characters/mannequiny_ragdoll",
  ...
  {
    "name": "Rigidbody Character (3D): level",
  ...
  {
    "name": "Soft Body Physics (3D): test",
    "file": "demos/3d/soft_body_physics/test.tscn",
    "category": "Godot Demos - 3D",
    "root": "demos/3d/soft_body_physics"
  },
  {
    "name": "Sprites (3D): 3d_sprites",
  ...
  {
    "name": "Squash The Creeps (3D): Main",
  ...
  {
    "name": "Tonemap Color Correction (3D): test",
    "file": "demos/3d/tonemap_color_correction/test.tscn",
    "category": "Godot Demos - 3D",
    "root": "demos/3d/tonemap_color_correction"
  },
  {
    "name": "Truck Town (3D): car_select/car_select",
  ...
  {
    "name": "Volumetric Fog (3D): volumetric_fog",
  ...
  {
    "name": "Voxel (3D): menu/main/main_menu",
  ...
  {
    "name": "Screen Capture (Viewport): screen_capture",
  ...
  {
    "name": "Split Screen Input (Viewport): split_screen_demo",
