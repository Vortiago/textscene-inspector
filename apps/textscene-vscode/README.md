...
- On a **trackpad**, Shift+two-finger scroll pans and pinch zooms; on a **tablet**, one finger orbits, a tap selects, two fingers pan and pinch zooms. Press **?**, or click the summary pill over the viewport, for the full list on whichever device you are using.
