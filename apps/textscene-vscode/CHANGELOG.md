...
### Added
- `.tscn` syntax highlighting: a TextMate grammar for section headings, property keys, strings, numbers, booleans, and Godot's typed-literal constructors (`SubResource(...)`, `Color(...)`, `Vector3(...)`, `PackedFloat32Array(...)` and so on), including nested arrays and dictionaries.
