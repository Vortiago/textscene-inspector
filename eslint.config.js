...
export default [
  ...
  // TypeScript files - Node.js environment (extension main code)
  {
    files: ['apps/textscene-vscode/src/**/*.ts'],
  ...
  // Config files (TypeScript) - Node.js environment
  {
    files: ['**/*.config.ts', 'vitest.shared.ts'],
    languageOptions: {
      parser: tsparser,
      parserOptions: {
        ecmaVersion: 'latest',
