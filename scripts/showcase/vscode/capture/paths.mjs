...
// self-contained .tscn with no .csproj/.cs, so the C# Dev Kit never activates
// and hijacks focus with its welcome page.
export const WS = `${REPO_ROOT}/scenes/fixtures`;
