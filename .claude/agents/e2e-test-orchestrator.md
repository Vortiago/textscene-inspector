...
description: Orchestrate comprehensive end-to-end test execution with browser automation. Use when running full test suites, creating test plans, validating features, or investigating test failures across the TSCN renderer project.
...
**C. Store Test Plans**
- Save test plans in `test-plans/` directory at repository root
- Use descriptive filenames: `test-plans/[feature-name]-test-plan.md`
...
- Search `test-plans/` directory for plans matching the feature
...
**File Organization:**
- Test plans: `test-plans/[feature].md`
- Test TSCN files: `test-plans/fixtures/[feature]/[scenario].tscn`
- Reference screenshots: `test-plans/screenshots/[feature]/[scenario].png`
